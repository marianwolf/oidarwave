...
- [Electron Integration](electron.md) - The Electron main process handles window creation, secure file protocol handling, dynamic page discovery, and application lifecycle management for the Oidarwave desktop app.
