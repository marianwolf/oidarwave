...
description: Documents the UI components in index.html and video/index.html, styled by src/css/style.css, including the station selector, player controls, status indicators, cookie consent banner, and footer.
tags:
  - ui
  - frontend
  - html
...
- Detects presence of `#audioPlayer` or `#videoPlayer`
- Sets appropriate event listeners and storage keys (`lastStationAudioUrl` or `lastStationVideoUrl`)
